...
class BaseReporter:
    ...
    def report(self, results_by_repo: Dict[Path, List["CheckResult"]], ratings: Dict[Path, "CodebaseRating"]) -> None:
    ...
    def report_single(self, results: List["CheckResult"], rating: "CodebaseRating", repo_path: Path) -> None:
