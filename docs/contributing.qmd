...
- [Source Code](https://github.com/aeturrell/panoptipy)
- [Documentation](https://aeturrell.github.io/panoptipy/)
- [Issue Tracker](https://github.com/aeturrell/panoptipy/issues)

## How to report a bug

Report bugs on the [Issue Tracker](https://github.com/aeturrell/panoptipy/issues).
...
Request features on the [Issue Tracker](https://github.com/aeturrell/panoptipy/issues).
...
Open a [pull request](https://github.com/aeturrell/panoptipy/pulls) to
